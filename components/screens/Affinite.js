...
export const Affinite = ({ route, navigation }) => {
  ...
  const { routeName, userConsent, loveCoach, userEmail, userPhone, userCity, accesPosition, genre, userBirth, userSize, userLang, userSituation, userOrientation, userRecherche1, userRecherche2 } = route.params ?? {};
    ...
    <View style={Styles.container}>
      <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
        ...
        <View style={[Styles.ViewBTNSelect2, { top: 80 }]}>
          ...
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Amis.es des Animaux')} accessibilityLabel="Amis.es des Animaux">
          ...
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Mélomane')} accessibilityLabel="Mélomane">
            <Text style={selectedAffinite.includes('Mélomane') ? Styles.btnSelected : Styles.btnNotSelected}>Mélomane</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Artiste dans l\'âme')} accessibilityLabel="Artiste dans l'âme">
            <Text style={selectedAffinite.includes('Artiste dans l\'âme') ? Styles.btnSelected : Styles.btnNotSelected}>Artiste dans l&apos;âme</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Aventurier.ère')} accessibilityLabel="Aventurier.ère">
            <Text style={selectedAffinite.includes('Aventurier.ère') ? Styles.btnSelected : Styles.btnNotSelected}>Aventurier.ère</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Passionné.e de Lecture')} accessibilityLabel="Passionné.e de Lecture">
            <Text style={selectedAffinite.includes('Passionné.e de Lecture') ? Styles.btnSelected : Styles.btnNotSelected}>Passionné.e de Lecture</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Fashion Addict')} accessibilityLabel="Fashion Addict">
            <Text style={selectedAffinite.includes('Fashion Addict') ? Styles.btnSelected : Styles.btnNotSelected}>Fashion Addict</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[Styles.btn, Styles.mt10]} onPress={() => handleButtonPress('Cinéphile')} accessibilityLabel="Cinéphile">
            <Text style={selectedAffinite.includes('Cinéphile') ? Styles.btnSelected : Styles.btnNotSelected}>Cinéphile</Text>
          </TouchableOpacity>
        </View>

        <TouchableOpacity
          style={selectedAffinite.length === 0 ? Styles.btnMT60Disabled : Styles.btnMT60}
          disabled={selectedAffinite.length === 0}
          onPress={() => {
        ...
        <TouchableOpacity style={Styles.btnMT60White} onPress={() => navigation.goBack()}>
          <Text style={[Styles.btnText, Styles.btnTextWhite]}>Revenir en arrière</Text>
        </TouchableOpacity>
      </ImageBackground>
    </View>
  );
